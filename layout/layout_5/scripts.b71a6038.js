...
var observable = function observable() {
  ...
  var button = document.getElementById('myButton'); // create an observable of button clicks
...
var subscription = function subscription() {
  ...
  var myObservable = (0, _rxjs.fromEvent)(button, 'click'); // for now, let's just log the event on each click
...
var operator = function operator() {
  var dataSource = (0, _rxjs.of)(1, 2, 3, 4, 5); // subscribe to our source observable

  var subscription = dataSource.pipe( // add 1 to each emitted value
...
function init() {// ? Observable____________________________________________________________________________________
  ...
  // * --- transformation (дає методи для трансформування вхідної інформації)
}
